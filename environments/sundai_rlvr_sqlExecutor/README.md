...
```bash
prime eval run sundai-rlvr-sqlExecutor
```

Configure model and sampling:

```bash
prime eval run sundai-rlvr-sqlExecutor   -m gpt-4.1-mini   -n 20 -r 3 -t 1024 -T 0.7   -a '{"key": "value"}'  # env-specific args as JSON
```
